...
ROOT_DOWNLOAD_URL = (
    "https://github.com/Turg-er/bajerino/releases/download/nightly-build"
)
WIN_X64_INSTALLERS = ["Bajerino.Nightly.Installer.exe"]
WIN_ARM64_INSTALLERS = ["Experimental-ARM64-Bajerino.Nightly.Installer.exe"]
...
def get_last_version_tag() -> str | None:
    try:
        return run_git_command(["describe", "--tags", "--abbrev=0", "--match", "v*"])
...
print(
    ...
    f"https://github.com/Turg-er/bajerino/releases/tag/{get_current_stable()}.\n"
)
